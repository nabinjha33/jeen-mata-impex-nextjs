...
import { User, DealerApplication, SiteSettings } from "@/lib/entities";
...
export default function DealerLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (user) {
        ...
        router.push(createPageUrl("DealerCatalog"));
      } else {
        setSubmitStatus({
          type: 'error',
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSubmitStatus({
        type: 'success',
        message: 'Your dealer application has been submitted successfully! Our team will review your request and contact you within 24 hours.'
      });
  ...
  return (
    <Layout currentPageName="DealerLogin">
