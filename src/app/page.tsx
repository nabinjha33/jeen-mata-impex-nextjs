          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {brands.map((brand: any) => (
                <Link
                  key={brand.id}
                  href={createPageUrl(brand.slug === 'fastdrill' ? 'FastDrillBrand' : brand.slug === 'spider' ? 'SpiderBrand' : brand.slug === 'gorkha' ? 'GorkhaBrand' : 'GeneralImportsBrand')}
                  className="group"
                >
            ...
            {isLoading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {featuredProducts.map((product: any) => (
                  <Link
                    key={product.id}
                    href={`${createPageUrl("ProductDetail")}?slug=${product.slug}&from=Home`}
